...
public class ConsolaBanco {
	...
	public static void main(String[] args) {
		...
		HashMap<Integer, String > mensajes = new HashMap<>();
		...
		do {
			...
			System.out.println("14. obtener mensajes");
			...
			case 15:
				...
				Mensaje m1 = new Mensaje(1, Mensaje.TIPO_CLIENTE, 55 ,Mensaje.TIPO_GESTOR, 44 ,"mensaje prueba");
				
				System.out.println("Mesnaje" + m1);
